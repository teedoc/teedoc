...
# get version str
version_path = os.path.join(curr_dir, "teedoc_plugin_theme_default", "version.py")
...
setup(
    ...
    package_data={
        "teedoc_plugin_theme_default" : ['assets/*', 'templates/*', 'locales/*/*/*.po', 'locales/*/*/*.mo', 'locales/*.pot'],
    },
