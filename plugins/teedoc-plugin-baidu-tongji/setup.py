...
import os
from teedoc_plugin_baidu_tongji import __version__
...
# get version str
version_path = os.path.join(curr_dir, "teedoc_plugin_baidu_tongji", "version.py")
...
setup(
    ...
    keywords='baidu tongji doc website markdown jupyter notbook generator teedoc search plugin',
